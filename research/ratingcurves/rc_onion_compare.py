...
class RCDist(RCData):
	...
	def plot_rc(self,filename=False,hand=True,xs=True,ci=True,alpha=0.05,div=5,kind='linear'):
...
if __name__ == '__main__':
	...
	for comid in comids:
		try: 
			...
			# print 'Rating curve for COMID {0} / USGSID {1} successfully created'.format(str(comid),str(usgsid))
		...
		rcdist.plot_rc(filename=False,hand=True,xs=True,ci=True,alpha=0.05,div=5,kind='linear')
