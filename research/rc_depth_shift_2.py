...
if __name__ == '__main__':
	...
	for comid in comids:
		try: 
			...
			# rcdist.draw_xsect(save='results/xsects/gzf_shift/hand_vs_usgs_xsect_ratingnumber_gzfshift_{0}'.format(str(comid)))
			...
			# rcdist.plot_rc(#save='results/usgs_hand_only/hand_vs_usgs_rc_{0}'.format(str(comid)),
			# 	save=False,
