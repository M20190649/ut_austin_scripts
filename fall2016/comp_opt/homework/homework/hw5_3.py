...
if __name__ == '__main__':
	...
	def draw_shortest_path(curloc='Engineering Teaching Center',
		dest=False,zoom=False,file=False):
		nw.map.clear()

		if dest:
			start = nw.get_closest_node(curloc)
			end = nw.get_closest_node(dest)
		...
		nw.draw_edges()
		nw.draw_nodes(currentloc=curloc)
	...
	draw_shortest_path(curloc='Engineering Teaching Center',
		dest='Hula Hut',zoom=(-97.796, 30.278, -97.725, 30.314))
